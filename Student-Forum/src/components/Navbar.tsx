...
import quora from "../assets/Student.png"
  ...
  return (
    <div className="flex pl-20 pt-3 shadow-md h-14 w-screen">
      ...
      <div className="flex border border-spacing-1 h-9 ml-10 w-72 p-1 cursor-pointer">
        ...
        <input onChange={(e)=> props?.setSearch(e.target.value)} placeholder="Search Student Forum" className="ml-2 outline-none"/>
      </div>
      <h1 className="text-sm border border-spacing-1 rounded-full p-2 ml-5 h-9">Try Forum+</h1>
