  ...
  return (
    ...
    className="flex items-center justify-center">
      <div className="bg-white h-11/12 w-7/12 rounded-sm p-8">
        <h1 className="text-red-700 text-6xl font-bold font-serif text-center"> Student Forum</h1>
        <h1 className="text-center font-bold text-gray-500 mt-3">A place to share knowledge and better understand the world</h1>
        <div className="flex mt-10">
        <div>
        <h1 className="text-zinc-400 text-sm w-72">By continuing you indicate that you agree to Forum’s 
        ...
        <hr className="mt-3"/>
        <h1 className="text-sm text-center mt-3 text-zinc-600">About . Careers . Privacy . Terms . Contact . Languages . Your . Ad . Choices . Press© Forum, Inc. 2025</h1>
      </div> 
